...
## Project Structure
    ...
    ├── wandering_brook_29569  # Django project configurations
...
1. Clone this repo and `cd wandering_brook_29569`
...
2. Clone this repo and `cd wandering_brook_29569`
